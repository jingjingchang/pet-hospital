var articleCategoryList = function () {
    var zNodes ="";
    this.url = {
        listByPage:"/admin/blog/articleCategory/listByPage",
        create:"/admin/blog/articleCategory/create",
        deleteCategory:"/admin/blog/articleCategory/remove",
        updateCategory:"/admin/blog/articleCategory/update",
    };
    this.init = function () {
        this.validInit();
    };
