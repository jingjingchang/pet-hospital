var utilWebList = function () {
    var zNodes ="";
    this.url = {
        listByPage:"/admin/blog/utilWeb/listByPage",
        create:"/admin/blog/utilWeb/create",
        deleteUtilsWeb:"/admin/blog/utilWeb/remove",
        updateUtilsWeb:"/admin/blog/utilWeb/update",
    };
    this.init = function () {
        this.validInit();
    };
