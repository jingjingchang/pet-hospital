var utilWebCategory = function () {
    var zNodes ="";
    this.url = {
        listByPage:"/admin/blog/utilWebCategory/listByPage",
        create:"/admin/blog/utilWebCategory/create",
        deleteUtilsWebCategory:"/admin/blog/utilWebCategory/remove",
        updateUtilsWebCategory:"/admin/blog/utilWebCategory/update",
    };
    this.init = function () {
        this.validInit();
    };
    this.loadTableData = function () {
        ...
        $('#utilWebCategory').bootstrapTable({
            striped: true,
            pagination: true,
